...
module.exports = DirBase.extend({
  ...
  writing: {
    ...
    item: function() {
      ...
      this.fs.copyTpl(
        this.templatePath('_item-view-test.js'),
    ...
    detail: function () {
      ...
      this.fs.copyTpl(
        this.templatePath('_detail-view-test.js'),
    ...
    create: function() {
      ...
      this.fs.copyTpl(
        this.templatePath('_create-view-test.js'),
    ...
    composite: function() {
      ...
      this.fs.copyTpl(
        this.templatePath('_composite-view-test.js'),
